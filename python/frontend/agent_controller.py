# PyQt6 version of AgentController (moved to frontend/)
...
class AgentControllerQt(QWidget):
    def __init__(self, name, port, shared_model=None, ppo_trainer=None, backend_adapter=None, parent=None):
        ...
        agent_layout.addWidget(actions_group)

        # Log area
        self.log_text = QTextEdit()
        self.log_text.setReadOnly(True)
        self.log_text.setMinimumHeight(80)
        agent_layout.addWidget(self.log_text)
        ...
        # Add agent_layout to main_layout
