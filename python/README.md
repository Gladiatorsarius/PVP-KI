...
- Main machine: runs coordinator + model/training + UI (`python/main.py`)
- VM machine(s): run thin runtime client (`python/client.py`) for frame capture and input execution
